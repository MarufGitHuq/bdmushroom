  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        {/* Quick Add Button */}
        <div className="absolute bottom-3 right-3 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
          <Button
            size="icon"
            className="h-12 w-12 rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-lg"
