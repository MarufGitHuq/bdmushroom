...
import { Menu, Phone, Mail, Linkedin, Instagram, Facebook, Youtube, Twitter, Globe, ShoppingBag, BookOpen, LayoutDashboard, Home, X } from "lucide-react";
...
const SideNav = () => {
  ...
  return (
    <>
      ...
      <nav className={cn(
        "fixed left-0 top-0 h-screen bg-secondary z-50 flex flex-col items-center py-6 justify-between transition-all duration-300",
